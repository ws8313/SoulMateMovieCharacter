...
def store_options():
    ...
    for i in range(len(options)):
        option_1 = Option(i+1, options[i][0], mbti_indicator[i][0])
        option_2 = Option(i+1, options[i][1], mbti_indicator[i][1])

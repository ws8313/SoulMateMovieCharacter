...
import styles from "./ResultLoginModal.module.css";
import closebtn from "../img/closebtn.png";

const ResultLoginModal = ({ openResultLoginModal }) => {
            ...
            <div className={styles.modal}>
                ...
                <div>
                    ...
                    <input 
                        ...
                        />
                    <img src={closebtn} alt="closebtn" onClick={ openResultLoginModal } className={styles.modal_button} />
                ...
                <div>
                    ...
                    <img 
                        src={closebtn} 
                        alt="closebtn" 
                        onClick={ () => clickHandler(openResultLoginModal) } 
...
export default ResultLoginModal;